...
const CONTEXT_BAR_MODE_VALUES = Object.keys(CONTEXT_BAR_MODES);
...
export const ContextBarWidget = defineWidget({
    ...
    render({ ctx, options, renderWidget }) {
        ...
        return renderWidget(contextBar(ctx.contextTokens, ctx.contextMaxTokens, contextBarMode, tokenFormatStyle), {
...
function contextBar(tokens, maxTokens, contextBarMode, tokenFormatStyle) {
    ...
    if (tokens === undefined || maxTokens === undefined || percent === undefined)
        return "?";
