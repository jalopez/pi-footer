...
import { CONFIG_UI_HEIGHT_RATIO } from "./model.js";
...
import { createScreenState } from "./screen-state.js";
...
export class StatuslineConfigScreen {
    ...
    registerScreens() {
        ...
        this.screenController.register("line-list", new LineListScreen(this.screenContext, this.screenRender, "Edit lines", "widget-list"));
        this.screenController.register("color-line-list", new LineListScreen(this.screenContext, this.screenRender, "Edit colors", "color-widget-list"));
        this.screenController.register("widget-list", new WidgetListScreen(this.screenContext, this.screenRender, false));
        this.screenController.register("color-widget-list", new WidgetListScreen(this.screenContext, this.screenRender, true));
        this.screenController.register("add-widget", new AddWidgetScreen(this.screenContext, this.screenRender));
        this.screenController.register("edit-widget", new EditWidgetScreen(this.screenContext, this.screenRender));
        this.screenController.register("edit-colors", new EditColorsScreen(this.screenContext, this.screenRender));
        this.screenController.register("terminal", new TerminalScreen(this.screenContext, this.screenRender, terminalState));
        this.screenController.register("confirm-color-level", new ColorLevelConfirmScreen(this.screenContext, this.screenRender, terminalState));
        this.screenController.register("confirm-exit", new ConfirmExitScreen(this.screenContext, this.screenRender));
        this.screenController.register("global", new GlobalScreen(this.screenContext, this.screenRender));
        this.screenController.register("extension-status-row", new ExtensionStatusRowScreen(this.screenContext, this.screenRender));
    }
    createScreenContext() {
        return {
            state: this.state,
    ...
    getVisibleRowCount() {
        return visibleRowCount(this.getTerminalRows(), CONFIG_UI_HEIGHT_RATIO, this.getActiveLineCount());
    }
    getActiveLineCount() {
    ...
    async saveConfig(exitAfterSave) {
        ...
        try {
            ...
            if (exitAfterSave)
                this.closeWithResult(this.lifecycle.closeResult(true));
        }
        catch {
